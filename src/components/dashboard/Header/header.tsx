...
const MenuItems: IMenuItem[] = [
  ...
  },
  {
    ...
    subMenu: [
      {
        id: "citem1",
        label: "Menu 3 Collapse Item 1",
        icon: <MailIcon />,
        url: "/"
      },
      {
        id: "citem2",
        label: "Menu 3 Collapse Item 2",
        icon: <InboxIcon />,
        url: "/"
      },
      {
        id: "citem3",
        label: "Menu 3 Collapse Item 3",
        icon: <MailIcon />,
        url: "/"
      },
      {
        id: "citem4",
        label: "Menu 3 Collapse Item 4",
        icon: <InboxIcon />,
        url: "/"
      }
    ]
  ...
  { id: "item4", label: "Menu 4", icon: <InboxIcon />, url: "/" },
  {
    ...
    subMenu: [
      {
        id: "citem1",
        label: "Menu 5 Collapse Item 1",
        icon: <MailIcon />,
        url: "/"
      },
      {
        id: "citem2",
        label: "Menu 5 Collapse Item 2",
        icon: <InboxIcon />,
        url: "/"
      },
      {
        id: "citem3",
        label: "Menu 5 Collapse Item 3",
        icon: <MailIcon />,
        url: "/"
      },
      {
        id: "citem4",
        label: "Menu 5 Collapse Item 4",
        icon: <InboxIcon />,
        url: "/"
      }
    ]
